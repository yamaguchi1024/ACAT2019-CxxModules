...
In CMSSW, as shown in Figure \ref{fig:graphofcmssw}, SCRAM build system resolves library dependencies and executes and also C++ compiler such as gcc ROOT Genreflex, which is a wrapper of rootcling. Rootcling generates CMS ROOT dictionaries, rootmaps, and RDICTs, as it was in ROOT. At the same time, gcc compiles C++ files and generates CMS shared object libraries. 
